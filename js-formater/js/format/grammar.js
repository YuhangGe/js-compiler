...
function func_TryStatement(try,Block,CatchClauses) {
	//TryStatement->try Block CatchClauses
}
function func_TryStatement_0(try,Block,FinallyClause) {
	//TryStatement->try Block FinallyClause
}
function func_TryStatement_1(try,Block,CatchClauses,FinallyClause) {
...
function func_CatchClause(catch,p1,Identifier,p3,Block) {
	//CatchClause->catch ( Identifier ) Block
}
function func_FinallyClause(finally,Block) {
	//FinallyClause->finally Block
}
function func_ReturnStatement(return,OptionalExpression) {
	//ReturnStatement->return OptionalExpression
}
function func_ThrowStatement(throw,Expression) {
	//ThrowStatement->throw Expression
}
function func_WithStatement(with,ParenthesizedExpression,Statement) {
...
function func_ForStatement_0(_for,p1,ForInBinding,in,Expression,p5,Statement) {
...
function func_SwitchStatement(switch,ParenthesizedExpression,p2,p3) {
	//SwitchStatement->switch ParenthesizedExpression { }
}
function func_SwitchStatement_0(switch,ParenthesizedExpression,p2,CaseGroups,LastCaseGroup,p5) {
...
function func_CaseGuard(case,Expression,p2) {
	//CaseGuard->case Expression :
}
function func_CaseGuard_0(default,p1) {
	//CaseGuard->default :
}
function func_SwitchStatement_1(switch,ParenthesizedExpression,p2,p3) {
	//SwitchStatement->switch ParenthesizedExpression { }
}
function func_SwitchStatement_2(switch,ParenthesizedExpression,p2,CaseGroups,LastCaseGroup,p5) {
	//SwitchStatement->switch ParenthesizedExpression { CaseGroups LastCaseGroup }
}
...
function func_CaseGuard_1(case,Expression,p2) {
	//CaseGuard->case Expression :
}
function func_CaseGuard_2(default,p1) {
	//CaseGuard->default :
}
...
function func_RelationalExpression_4(RelationalExpression,instanceof,ShiftExpression) {
	//RelationalExpression->RelationalExpression instanceof ShiftExpression
}
function func_RelationalExpression_5(RelationalExpression,in,ShiftExpression) {
...
function func_UnaryExpression_0(delete,LeftSideExpression) {
	//UnaryExpression->delete LeftSideExpression
}
function func_UnaryExpression_1(void,UnaryExpression) {
	//UnaryExpression->void UnaryExpression
}
function func_UnaryExpression_2(typeof,UnaryExpression) {
...
function func_FullNewExpression(new,FullNewSubexpression) {
	//FullNewExpression->new FullNewSubexpression
}
function func_ShortNewExpression(new,ShortNewSubexpression) {
...
function func_SimpleExpression() {
	//SimpleExpression->this
}

function func_SimpleExpression_0() {
...
function func_SimpleExpression_3(Number) {
	//SimpleExpression->Number
}

function func_SimpleExpression_4(String) {
...
function func_SimpleExpression_6(RegExp) {
